...
const statusColors = {
    [WorkflowStatus.DRAFT]: "bg-yellow-300 text-yellow-800",
...
function WorkflowCard({ workflow }: { workflow: Workflow }) {
    ...
    return (
        <Card className="border border-separate shadow-sm -rounded-lg overflow-hidden hover:shadow-md dark:shadow-primary/30 transition-colors duration-200 ease-in-out">
                ...
                <div className="flex items-center justify-end space-x-3">
                    ...
                    <div>
                        <h3 className="text-base font-bold text-muted-foreground flex items-center">
                            <Link href={`/workflows/editor/${workflow.id}`} className="flex items-center hover:underline">{workflow.name}</Link>
